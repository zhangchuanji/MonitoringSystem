  ...
  <div>
    ...
    <a-card class="qwe">
      ...
      <div class="search">
        ...
        <a-input v-model:value="formSearchState.fullName" placeholder="请输入仓库名称" />
      </div>
    </a-card>
    ...
    <!-- 新增数据弹出框 -->
    <a-modal class="addModal" width="50rem" v-model:visible="AddVisible" title="新增仪表" :destroyOnClose="true"
      :footer="null">
      <a-form layout="inline" ref="addformRef" :rules="addrules" :model="form.formAddState">
        <a-form-item label="仪表名称" name="number">
          <a-input v-model:value="form.formAddState.name" placeholder="请输入仓库编号" />
        </a-form-item>
        <a-form-item label="仪表编号" name="business">
